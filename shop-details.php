                                ...
                                <ul>
                                    ...
                                    <li><a href="shop.php">Product</a>
                                     <li><a href="about.php">About</a></li>
                                            ...
                                            <li><a href="portfolio.php">Galley</a>
                                  ...
                                  <li><a href="logout.php"  style="width: 100px;background-color: #70c745;display: inline-block;border-radius: 10px;font-size: 20px;font-weight: 500;   
                                         padding-left: 20px;" >Logout</a>          
                                 </li>
        ...
        <div class="produts-details--content mb-50">
            ...
            <div class="container">
                ...
                include_once('config.php');
                  ...
                  $a =mysqli_query($t," select * from product where p_id='".$_GET['p']."'");
                ...
                <div class="row justify-content-between">
                        ...
                        <div class="single_product_thumb">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <img class="d-block w-100" src="img/bg-img/<?=$v['filename']?>" alt="1">
                                    </a>
                                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single_product_desc">
                            <h4 class="title"><?=$v['productname']?></h4>
                            ...
                            <div class="cart--area d-flex flex-wrap align-items-center">
                                ...
                                <form class="cart clearfix d-flex align-items-center" method="post">
                                    <div class="quantity">
                                      ...
                                      <div> <a style=" width: 135px; background-color: #1065b7; text-align: center; font-weight: 800; padding: 11px 0px; color: white; font-size: 12px; display: inline-block; text-decoration: none; " href='order.html' > Buy Now </a> </div>
                            ...
                            <div class="products--meta">
                                <p><span>SKU:</span> <span>CT2252222</span></p>
                                <p><span>Category:</span> <span>vdvhyvbbcxbvbd</span></p>
                                <p><span>niteshs:</span> <span>plants,dsbdgn cactus </span></p>
                                <p>
                                    <span>Share on:</span>
                                    <span>
